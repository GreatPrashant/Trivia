...
import com.prashant.app.TriviaRenderer;
...
public class TextObject {
     ...
     public TextObject(){//float[] mMVPMatrix, float[] mMMatrix, float[] mVMatrix, float[] mProjMatrix) {
         super();
         //
         bitmapWidth = 1;
         bitmapHeight = 1;
...
//         this.mProjMatrix = mProjMatrix;
    ...
    public void init() {
        ...
        TriviaRenderer.checkGLError("loadShaders");

        mProgram = GLES20.glCreateProgram();             // Create empty OpenGL Program
        GLES20.glAttachShader(mProgram, vertexShader);   // Add the vertex shader to program
        TriviaRenderer.checkGLError("glAttachShader:vert");
        GLES20.glAttachShader(mProgram, fragmentShader); // Add the fragment shader to program
        TriviaRenderer.checkGLError("glAttachShader:frag");
        GLES20.glLinkProgram(mProgram);                  // Creates OpenGL program executables
        TriviaRenderer.checkGLError("glLinkProgram");
        GLES20.glUseProgram(mProgram);
        TriviaRenderer.checkGLError("glUseProgram");

        // Get handle to the vertex shader's vPosition member
        maPositionHandle = GLES20.glGetAttribLocation(mProgram, "vPosition");
        TriviaRenderer.checkGLError("glGetAttribLocation:vPosition");
        // Get handle to the vertex shader's vPosition member
        maTexCoordsHandle = GLES20.glGetAttribLocation(mProgram, "vTexCoord");
        TriviaRenderer.checkGLError("glGetAttribLocation:vTexCoord");
        // get handle to uniform parameter
        muMVPMatrixHandle = GLES20.glGetUniformLocation(mProgram, "uMVPMatrix");
        TriviaRenderer.checkGLError("glGetUniformLocation:uMVPMatrix");
        muTextureHandle = GLES20.glGetUniformLocation(mProgram, "u_s2dTexture");
        TriviaRenderer.checkGLError("glGetUniformLocation:u_s2dTexture");

        GLES20.glHint(GLES20.GL_GENERATE_MIPMAP_HINT, GLES20.GL_NICEST);
        TriviaRenderer.checkGLError("glHint");
        GLES20.glActiveTexture(GLES20.GL_TEXTURE0);
        TriviaRenderer.checkGLError("glActiveTexture");
        GLES20.glGenTextures(1, textureId, 0);
        TriviaRenderer.checkGLError("glGenTextures");
        //
        GLES20.glUniform1i(muTextureHandle, 0);
        TriviaRenderer.checkGLError("glUniform1i");
        GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, textureId[0]);
        TriviaRenderer.checkGLError("glBindTexture");
        // Setup texture parameters
        GLES20.glTexParameterf(GLES20.GL_TEXTURE_2D, GLES20.GL_TEXTURE_MAG_FILTER, GLES20.GL_LINEAR);
        TriviaRenderer.checkGLError("glTexParameterf:GL_TEXTURE_MAG_FILTER");
        GLES20.glTexParameterf(GLES20.GL_TEXTURE_2D, GLES20.GL_TEXTURE_MIN_FILTER, GLES20.GL_LINEAR_MIPMAP_LINEAR);
        TriviaRenderer.checkGLError("glTexParameterf:GL_TEXTURE_MIN_FILTER");
        GLES20.glTexParameterf(GLES20.GL_TEXTURE_2D, GLES20.GL_TEXTURE_WRAP_S, GLES20.GL_CLAMP_TO_EDGE);
        TriviaRenderer.checkGLError("glTexParameterf:GL_TEXTURE_WRAP_S");
        GLES20.glTexParameterf(GLES20.GL_TEXTURE_2D, GLES20.GL_TEXTURE_WRAP_T, GLES20.GL_CLAMP_TO_EDGE);
        TriviaRenderer.checkGLError("glTexParameterf:GL_TEXTURE_WRAP_T");
    }
        ...
        public void updateCamera(int aWidth,
                          int aHeight) {
        ...
        private void drawCanvasToTexture(
            ...
            TriviaRenderer.checkGLError("glGenerateMipmap");
        }
        /* [Draw Canvas To Texture] */
